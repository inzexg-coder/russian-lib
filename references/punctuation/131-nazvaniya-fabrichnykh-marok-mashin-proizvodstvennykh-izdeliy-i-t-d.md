...
| Примечание |
|---|
| Не выделяются кавычками наименования марок тех производственных изделий, которые стали общеупотребительными названиями, например: наган, браунинг, френч, галифе, макинтош, наполеон (пирожное) и т. п.
