...
| Примечание 1 |
|---|
| Если главное предложение находится внутри придаточного (в разговорном стиле речи), то запятая обычно ставится только после главного предложения, например: Хозяйством нельзя сказать, чтобы он занимался… (Гоголь) (ср.: Нельзя сказать, чтобы он занимался хозяйством). |
