...
| Примечание |
|---|
| Если частица -то попадает в середину сложного слова, часть которого соединяется дефисом, то дефис пишется только перед частицей, а после нее опускается, например: Шуры-то муры ваши с сестрицей моей я вижу (Тургенев).
