...
а) Оттого, что он говору́т (занимается разговорами), мало толку;
...
| Примечание 3 |
|---|
| В разговорном стиле речи встречаются конструкции с написанием, отступающим от правила, например: Почему ты на меня сердишься? – Да по тому са́мому (раздельное написание объясняется наличием слова са́мому, выступающего в роли усилительной частицы). |
