...
разва́лец – разва́льца (чаще употребляется первая форма);
...
ска́ред – ска́реда (формы равноправные);
